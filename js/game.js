...
export const Game = function() {
  ...
  this._player = [new UI(0)]
  for (var id = 1; id < 4; id++) {
    this._player[id] = new Player(id)
  }
}
...
Game.prototype.qipai = function() {
  ...
  this._model = {
    shan: new Shan(this._chang.hongpai),
    shoupai: [],
    he: [],
  }
  ...
  for (var l = 0; l < 4; l++) {
    ...
    this._model.shoupai[l] = new Shoupai(qipai[l])
    this._model.he[l] = new He()
  }
...
Game.prototype.pingju = function(name) {
  ...
  if (name == '荒牌平局') {
    ...
    for (var l = 0; l < 4; l++) {
      if (
        utilXiangting(this._model.shoupai[l]) == 0 &&
        utilTingpai(this._model.shoupai[l]).length > 0
      ) {
        n_tingpai++
