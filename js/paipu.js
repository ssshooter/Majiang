...
Game.Paipu.prototype.player_id = Game.prototype.player_id

Game.Paipu.prototype.audio_play = Game.prototype.audio_play

Game.Paipu.prototype.say = Game.prototype.say

Game.Paipu.prototype.kaiju = function() {
  var self = this
...
Game.Paipu.prototype.next = function() {
  var self = this
  ...
  if (
    ...
    !(
      data.pingju &&
      data.pingju.shoupai.filter(function(x) {
        return x
      }).length == 3 &&
      data.pingju.fenpei.filter(function(x) {
        return x == 0
      }).length == 4
    )
  ) {
...
Game.Paipu.prototype._qipai = function(data) {
...
Game.Paipu.prototype._create_view = Game.prototype.create_view

Game.Paipu.prototype.create_view = function() {
...
Game.Paipu.prototype.qipai = function(data) {
  this._qipai(data)

  this.create_view()
}

Game.Paipu.prototype.zimo = function(data) {
...
Game.Paipu.prototype.dapai = function(data) {
...
Game.Paipu.prototype.fulou = function(data) {
  var self = this
...
Game.Paipu.prototype.gang = function(data) {
  var self = this
...
Game.Paipu.prototype.gangzimo = function(data) {
  var self = this
...
Game.Paipu.prototype.kaigang = function(data) {
  this._model.shan.kaigang(data.baopai)
  this._view.shan.redraw()
}

Game.Paipu.prototype.hule = function(data) {
  var self = this
...
Game.Paipu.prototype.pingju = function(data) {
  var self = this

  if (!this._delay) {
    if (
      data.shoupai.filter(function(x) {
        return x
      }).length == 3 &&
      data.fenpei.filter(function(x) {
        return x == 0
      }).length == 4
    ) {
      for (var l = 0; l < 4; l++) {
...
Game.Paipu.prototype.jieju = function(data) {
  var self = this
...
Game.Paipu.prototype.show_summary = function() {
  var self = this
...
Game.Paipu.prototype.seek = function(log_idx, idx) {
  var self = this
...
Game.Paipu.prototype.change_mode = function() {
  this.create_view()
