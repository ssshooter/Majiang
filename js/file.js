...
export const PaipuFile = function(storage) {
  this._paipu = []
...
PaipuFile.prototype.length = function() {
  return this._paipu.length
}

PaipuFile.prototype.stringify = function(idx) {
  if (idx == null) return JSON.stringify(this._paipu)
  else return JSON.stringify(this._paipu[idx])
}

PaipuFile.prototype.add_paipu = function(paipu) {
...
PaipuFile.prototype.get_paipu = function(idx) {
  return this._paipu[idx]
}

PaipuFile.prototype.del_paipu = function(idx) {
 ...
 *  ViewObj.PaipuFile
 */
ViewObj.PaipuFile = function(node, paipu_file) {
  this._node = node
...
ViewObj.PaipuFile.prototype.redraw = function() {
...
ViewObj.PaipuFile.prototype.error = function(msg) {
  var self = this
  this._node
    .find('.error')
...
export const PaipuEditor = function(storage) {
  var self = this

  this._model = new PaipuFile(storage)
  this._view = {
    paipu_file: new ViewObj.PaipuFile($('#editor .paipu_file'), this._model),
  }
...
PaipuEditor.prototype.start = function(paipu) {
  $('body')
    .removeClass('game')
    .addClass('editor')
  $('#game').hide()
...
PaipuEditor.prototype.set_handler = function(paipu) {
  var self = this
  ...
  var blob = new Blob([this._model.stringify()], { type: 'application/json' })
